...
extension HomeVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        if collectionView == self.topCollectionView {
                return 8 // Replace with count of your data for topCollectionView
            }

            return 8 // Replace with count of your data for bottomCollectionViewID
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            if collectionView == self.topCollectionView {
                ...
                let cellA = collectionView.dequeueReusableCell(withReuseIdentifier: topCollectionViewID, for: indexPath)

                // Set up cell
                cellA.backgroundColor = UIColor.clear
                return cellA
            } else {
                let cellB = collectionView.dequeueReusableCell(withReuseIdentifier: bottomCollectionViewID, for: indexPath)
